...
class CornellMovieCorpusProcessor:
    ...
    def __init__(self, lines='raw_data/movie_lines.txt', conversations='raw_data/movie_conversations.txt'):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-l', '--lines',
                        default='raw_data/movie_lines.txt',
                        help='Path to Cornell Corpus, "raw_data/movie_lines.txt"')
    parser.add_argument('-c', '--conversations',
                        default='raw_data/movie_conversations.txt',
                        help='Path to Cornell Corpus, "raw_data/movie_conversations.txt"')
    ...
    convs = processor.get_conversations()
